package com.filter.authenticationandauthorizationfilter.config.security.filters;

import com.filter.authenticationandauthorizationfilter.config.security.authentication.CustomAuthentication;
import com.filter.authenticationandauthorizationfilter.config.security.manager.CustomAuthManager;
...
//        4. if the object is  authenticated then send request to the next filter in filter chain
